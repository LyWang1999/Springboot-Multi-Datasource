...
public class OracleEntityGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUsername("kuluo");
        dsc.setPassword("321#@!go");
        dsc.setUrl("jdbc:mysql://rm-bp1z1y80kj9yv184p2o.mysql.rds.aliyuncs.com:3306/test?serverTimezone=Asia/Shanghai");
        ...
        pc.setParent(null);
        pc.setEntity("com.haitian.database.oracle.model");
        pc.setMapper("com.haitian.database.oracle.mapper");
        pc.setXml("com.haitian.database.oracle.mapper");
        //本项目没用，生成之后删掉
